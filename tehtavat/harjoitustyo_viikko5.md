...
- Ohjelmasta pystyy tekemään suorituskelpoisen [jar](https://github.com/ohjelmistotekniikka-hy/syksy-2020/blob/main/web/maven.md#jarin-generointi)-tiedoston komennolla _mvn package_ (0.5p)
- Projektista on tehty _github release_ (0.25p)
  - Release sisältää ohjelman uusimman version suorituskelpoisen jar-tiedoston
  - [Ohje](https://github.com/ohjelmistotekniikka-hy/syksy-2020/blob/main/web/release.md) releasen tekemiseen
...
- Ohjelman dokumentaatiossa on ainakin yksi sen jotain oleellista toiminnallisuutta kuvaava sekvenssikaavio (0.5p)
  ...
  - Lisää kaavio [edellisellä viikolla](https://github.com/ohjelmistotekniikka-hy/syksy-2020/blob/main/tehtavat/harjoitustyo_viikko4.md) tehtyyn dokumenttiin _arkkitehtuuri.md_
...
- Palautusrepositorioosi voi tehdä GitHub-issuieta, ks [ohje](https://github.com/ohjelmistotekniikka-hy/syksy-2020/blob/main/tehtavat/harjoitustyo_viikko5.md#issueiden-salliminen)
