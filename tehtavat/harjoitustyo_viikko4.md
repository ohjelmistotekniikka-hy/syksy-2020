...
- Koodin laatu (1p)
  ...
  - Checkstyle on otettu käyttöön
    - Ohje Checkstylen käyttöönottoon [täällä](https://github.com/mluukkai/ohjelmistotekniikka-syksy-2020/blob/master/web/checkstyle.md)
...
- Ohjelman alustava rakenne luokka/pakkauskaaviona (0.75p)
  ...
  - Voit tarvittaessa tehdä kaavion, josta ilmenee myös sovelluksen [pakkausrakenne](https://github.com/mluukkai/ohjelmistotekniikka-syksy-2020/blob/master/web/materiaali.md#pakkauskaavio)
