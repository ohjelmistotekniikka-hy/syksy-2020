...
Ohje maven-muotoisen projektin luomiseen NetBeansilla [täällä](https://github.com/mluukkai/ohjelmistotekniikka-syksy-2020/blob/master/web/tyon_aloitus.md#maven-projektin-luominen)
...
Katso lisää [viikon 2 laskareista](https://github.com/mluukkai/ohjelmistotekniikka-syksy-2020/blob/master/tehtavat/viikko2.md#3-testauskattavuus).
...
Ohje [täällä](https://github.com/mluukkai/ohjelmistotekniikka-syksy-2020/blob/master/tehtavat/viikko2.md#maven-komentojen-suorittaminen-netbeansista).
...
Katso lisää [täältä](https://github.com/mluukkai/ohjelmistotekniikka-syksy-2020/blob/master/web/checkstyle.md)

## JavaDoc

Katso lisää [täältä](https://github.com/mluukkai/ohjelmistotekniikka-syksy-2020/blob/master/web/javadoc.md)
...
JavaFX aiheuttaa hankaluuksia myös seuraavassa luvussa esitettyyn jar-tiedostojen generointiin, eräs tapa ongelmien kiertämiseen on kerrottu sitä seuraavassa luvussa [täällä](https://github.com/mluukkai/ohjelmistotekniikka-syksy-2020/blob/master/web/maven.md#javafx-ja-jar).
